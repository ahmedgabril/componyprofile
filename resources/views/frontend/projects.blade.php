    ...
    <div id="defaultTabContent">
        ...
        <div class=" grid  lg:grid-cols-5 md:grid-cols-2 sm:grid-cols-1 gap-4  justify-center  p-4 bg-white rounded-lg md:p-8  dark:bg-gray-800" id="services" role="tabpanel" aria-labelledby="services-tab">
                        ...
                        <div class=" card-pro   bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 " >
                            ...
                            <div class="p-5">
                                <a href="#">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white capitalize">Noteworthy technology acquisitions 2021</h5>
                                </a>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 capitalize text-wrap reak-words indent-1">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
                        ...
                        bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <div class="h-64">
                                    <img class="rounded-t-lg object-cover w-full h-64" src="{{ asset('img/cardimg.jpg') }}"   alt="" style="height: 256px!important" />
