...
<div
    ...
    x-show="show"
    class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50 container mx-auto"
...
>
    ...
    >
        <div class="absolute inset-0 bg-gray-500 dark:bg-gray-900 opacity-75"  wire:click.prevent="{{$resetdata}}"></div>
    </div>
    ...
    <div
        ...
        {{$postion == "center"?'translate-y-2/4':''}} "
        x-transition:enter="ease-out duration-300"
